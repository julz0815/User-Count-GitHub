...
module.exports = __toCommonJS(dist_src_exports);
var import_universal_user_agent = __nccwpck_require__(81);
var import_before_after_hook = __nccwpck_require__(108);
var import_request = __nccwpck_require__(986);
var import_graphql = __nccwpck_require__(463);
var import_auth_token = __nccwpck_require__(426);
...
module.exports = __toCommonJS(dist_src_exports);
var import_request3 = __nccwpck_require__(986);
var import_universal_user_agent = __nccwpck_require__(81);
...
// pkg/dist-src/with-defaults.js
var import_request2 = __nccwpck_require__(986);
...
module.exports = __toCommonJS(dist_src_exports);
var import_deprecation = __nccwpck_require__(800);
var import_once = __toESM(__nccwpck_require__(666));
...
module.exports = __toCommonJS(dist_src_exports);
var import_endpoint = __nccwpck_require__(995);
var import_universal_user_agent = __nccwpck_require__(81);
...
var import_request_error = __nccwpck_require__(190);
...
module.exports = __toCommonJS(dist_src_exports);
var import_core = __nccwpck_require__(461);
var import_plugin_request_log = __nccwpck_require__(823);
var import_plugin_paginate_rest = __nccwpck_require__(883);
var import_plugin_rest_endpoint_methods = __nccwpck_require__(752);
...
function getAllRepositoriesWithThrottle(org, maxRequestsPerMinute) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (true) {
            ...
            const response = yield octokit.repos.listForOrg({
                org,
                per_page: perPage,
                page
            });
...
function getContributors(owner, repo) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (true) {
            ...
            let response;
            try {
                response = yield octokit.repos.listCommits({
                    owner,
                    repo,
                    since: sinceDate,
                    page,
...
function writeContributorsToCSV(repo, contributors) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ;
        yield fs_1.promises.writeFile(filePath, csvContent);
        console.log(`---Commits have been written to ${filePath}\n`);
    });
}
function storeReposToFile(repositories) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getAllUsers() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (repositoriesExist) {
            ...
            const data = yield fs_1.promises.readFile('repositories.txt', 'utf8');
            console.log('Repos from file: ' + data);
            repositories = data.split('\n');
        }
        else {
            repositories = yield getAllRepositoriesWithThrottle(orgName, maxRequestsPerMinute);
        ...
        for (const repo of repositories) {
            ...
            yield wait(3000);
            const contributorFilesExist = yield fs_1.promises.access('repos/' + repo + '-contributors.csv')
                .then(() => true)
                .catch(() => false);
            if (contributorFilesExist) {
                ...
                const contributors = yield getContributors(orgName, repo);
                const numberOfContributors = contributors.length;
                console.log('--Commits for ' + repo + ': ' + numberOfContributors);
                yield writeContributorsToCSV(repo, contributors);
            }
        }
